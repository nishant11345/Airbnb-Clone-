          ...
          addedPhotos.map((link) => (
            <div key={link} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 py-2 px-3 text-white bg-black bg-opacity-50 rounded-2xl "
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 py-2 px-3 text-white bg-black bg-opacity-50 rounded-2xl "
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
